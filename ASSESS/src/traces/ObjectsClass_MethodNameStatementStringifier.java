...
public class ObjectsClass_MethodNameStatementStringifier extends StatementsStringifier {
	...
	public Statement getStatement(String s){
		...
		String[] st=s.split(":");
		ObjectClass callerclass=new ObjectClass(st[0]);
		ObjectInstance caller=new ObjectInstance("caller",callerclass);
		st=st[1].split("\\.");
		
		ObjectClass calleeclass=new ObjectClass(st[0]);
		ObjectInstance callee=new ObjectInstance("callee",calleeclass);
	...
	public static void main(String[] args){
		...
		ObjectsClass_MethodNameStatementStringifier o=new  ObjectsClass_MethodNameStatementStringifier();
